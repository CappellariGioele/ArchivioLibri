            ...
            <div class="card-body">
                <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Example" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required>
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea placeholder="Description of the book..." rows="5" maxlength="800" class="form-control @error('description') is-invalid @enderror" id="description" name="description">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3 col-12 col-sm-4">
                        ...
                        <input type="number" min="1" class="form-control @error('pages') is-invalid @enderror" placeholder="123" id="pages" name="pages" value="{{ old('pages') }}">
                        @error('pages')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3 col-12 col-sm-4">
                        ...
                        @enderror
                        <div class="mt-3">
                            <img id="image_preview" src="{{ asset('storage/images/book/no-cover.webp') }}" alt="Anteprima immagine" style="max-width: 200px; max-height: 260px; display: block;">
